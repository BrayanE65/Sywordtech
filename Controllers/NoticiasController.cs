...
namespace Sywordtech.Controllers
{
    ...
    public class NoticiasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Titulo,Subtitulo,Descripción,Fecha,Imagen")] Noticia noticia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Titulo,Subtitulo,Descripción,Fecha,Imagen")] Noticia noticia)
        {
            if (id != noticia.ID)
            {
                return NotFound();
